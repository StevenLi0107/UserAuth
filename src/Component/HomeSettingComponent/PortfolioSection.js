...
export default function PortfolioSection() {
    ...
    const handlePortfolioTitle=async(e)=>{
        ...
        {title, subtitle, text, homeportfolio_id});
  ...
  return (
    <div style={{width:"100%"}}>
        <Card title="Portfolio  title Setting " >
        <Form>
            <div style={outerstyle}>
            <Form.Control style={inputstyle} value={subtitle} onChange={(e) => { setSubTitle(e.target.value) }} placeholder='Enter Portfolio Sub-Title' />
            <Form.Control style={inputstyle} value={title} onChange={(e) => { setTitle(e.target.value) }} placeholder='Enter Portfolio Title' />
            <Form.Control style={inputstyle} value={text} onChange={(e) => { setText(e.target.value) }} placeholder='Enter Portfolio text' />
